...
**Finding activities for the kids:**

- Tags: For kids + Active
- Visited: Not visited
- Result: Family-friendly activities you haven't done
...
- **Map view:** Shows only matching place markers
...
- Filter by "High priority" + "Not visited" to tackle must-sees first

**Planning evening activities:**

- Filter by tags like "Restaurants" + "Date night" + "Not visited"

**Looking for backup plans:**

- Filter by "Indoor" + "Medium priority" in case of bad weather

**Checking progress:**

- Filter by "Visited" to see everywhere you've been